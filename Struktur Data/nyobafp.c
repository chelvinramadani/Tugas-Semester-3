...
int main()
{
    ...
    char namaList[][50] = {"Chelvin", "Devinka", "Wati", "Siti Rokaya", "Sutikno", "Sukamto", "Fitri", "Budi", "Supriyadi", "Sukini"};
    int umurList[] = {20, 20, 23, 24, 39, 54, 28, 58, 45, 65};
    char alamatList[][100] = {"Citraland gang Langgar", "kedungturi", "ngelom", "sepanjang", "mangunan", "megare", "tawangsari", "kalijaten", "ketegan", "bebekan"};
    ...
    do
    {
        ...
        case 2:
            ...
            break;
        case 3:
            printf("Masukkan NRM yang akan dicari: ");
            scanf("%d", &NRM);
